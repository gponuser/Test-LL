	...
	switch(Option)
		{
			        ...
			        if(val != -1)
        			{
		                	...
		                	while(1)	
		        	        {
	                		        ...
	                		        if(val == -1)
        		                	        ...
        		                	        sortedInsertNode(val);
	        		        }
        	        		displayList();
			    	}
				printf("\n Sorted List :: List Created ");
				break;
	
			case 2:
				printf("\n Sorted List :: Add Node - ");
				printf("\n Enter the value- ");
				scanf("%d",&val);
				sortedInsertNode(val);
				printf("\n Node Added \n");
			...
			case 4:
				printf("\n Sorted List :: Destroy List - ");
				break;
				
			case 5:
				printf("\n Sorted List :: Display List");
				displayList();
				break;
	
			case 6:
				printf("\n Sorted List :: Front Back Split");
				sortedFrontBackSplit();
				return(0);
...
void sortedInsertNode(int val)
{
	struct node *temp, *ptr;
	temp = head;
	ptr = head;
	if(ptr->data > val) // insert head
	{
		temp = (struct node*) malloc(sizeof(struct node));
		temp ->data = val;
		temp->next = head;
...
void sortedFrontBackSplit(struct node *fList, struct node* bList)
{
